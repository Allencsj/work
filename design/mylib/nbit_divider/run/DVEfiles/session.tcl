...
# DVE full session
# Saved on Sun Apr 24 23:16:15 2022
# Designs open: 1
...
#<Session mode="Full" path="/home/designer/work/design/lib/nbit_divider/run/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 66} {1914 888}}
...
gui_sg_addsignal -group "$_session_group_33" { tb.dut.start tb.dut.clk tb.dut.calu1 tb.dut.cnt tb.dut.state_r tb.dut.quotiend tb.dut.remainder tb.dut.done tb.dut.state_r tb.dut.calu1 tb.dut.divised_r tb.dut.divisor_r }

set _session_group_34 Group2
gui_sg_create "$_session_group_34"
set Group2 "$_session_group_34"

gui_sg_addsignal -group "$_session_group_34" { tb.dut.calu1_r tb.dut.calu2_r tb.dut.calu2 }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 1105
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_add_group -id ${Wave.1} -after {New Group} {Group2}
gui_list_select -id ${Wave.1} {tb.dut.state_r }
...
gui_marker_move -id ${Wave.1} {C1} 567
