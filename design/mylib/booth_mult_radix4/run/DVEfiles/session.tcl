...
# DVE full session
# Saved on Wed Apr 13 12:58:42 2022
# Designs open: 1
...
#<Session mode="Full" path="/home/designer/work/design/lib/booth_mult_radix4/run/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 37} {1917 863}}
...
gui_load_child_values {Mbooth_radix4_tb.booth_radix4}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 3081
...
gui_marker_move -id ${Wave.1} {C1} 3062
